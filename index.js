...
async function run() {
  try {
    ...
    app.get('/services', async(req, res)=> {
        ...
        // const query = { price: { $lte: 150, $gte:50 } }; // this sort will give you price range(50 to 150)
        const options = {
    ...
    //send bookings to ui (by query search) (read)
    ...
    // create bookings to database (create)
    ...
    app.patch('/bookings/:id', async(req, res) => {
        ...
        const updateBooking = req.body;
         console.log("updateBookin", updateBooking);
        const updateDoc = {
      $set: {
...
app.get("/", (req, res) => {
    res.send("CAR DOCTOR SERVER IS RUNNING ON")
})
